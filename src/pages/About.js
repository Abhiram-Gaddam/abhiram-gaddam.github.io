  ...
  const shortText = (
    <>
      <h1 className="font-bold text-xl font-serif">
        <p className="font-medium">Hello! I'm</p> Gaddam Bhanu Venkata Abhiram
      </h1>
      A third-year Computer Science and Business Systems student at R.V.R. & J.C. College of Engineering.
      My journey into technology began with a fascination for how software works and has grown into a passion for building impactful, user-friendly solutions.
    </>
  );
